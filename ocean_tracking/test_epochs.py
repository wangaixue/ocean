...
parser.add_argument('--RGBTSPLIT', default=None, type=str, help='RGBT or not')
parser.add_argument('--channel6', default=False, type=bool, help='input 6 channel or not')
...
for i in range(2):
    ...
    os.system('python ./ocean_tracking/test_ocean.py --arch {0} --resume {1} --dataset {2} --epoch_test True'.format(arch, resume, dataset))
