...
def parse_args():
    ...
    parser.add_argument('--arch', dest='arch', default='Ocean', help='backbone architecture')
    parser.add_argument('--resume', default="snapshot/Ocean.model", type=str, help='pretrained model')
