...
def _build_warm_up_scheduler(optimizer, cfg, epochs=50, last_epoch=-1):
    warmup_epoch = cfg.OCEAN.TRAIN.WARMUP.EPOCH
    sc1 = _build_lr_scheduler(optimizer, cfg.OCEAN.TRAIN.WARMUP,
                              warmup_epoch, last_epoch)
    sc2 = _build_lr_scheduler(optimizer, cfg.OCEAN.TRAIN.LR,
...
def build_lr_scheduler(optimizer, cfg, epochs=50, last_epoch=-1):
    if cfg.OCEAN.TRAIN.WARMUP.IFNOT:
